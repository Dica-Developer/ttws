    ...
    <table class="c-table c-table--striped">
      ...
      <tbody class="c-table__body">
        <tr class="c-table__row" data-path={ path } each={ files }>
          ...
          <td class="c-table__cell" style="zoom: 2;"><i class="fa fa-upload fa-2" aria-hidden="true" style="cursor: pointer;" onclick={ upload }></i><i id={ name } style="display:none;" class="fa fa-circle-o-notch fa-spin fa-2 fa-fw"></i>
</td>
        </tr>
      </tbody>
    </table>
